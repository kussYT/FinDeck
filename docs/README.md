...
> État du projet au 23 septembre 2026 : le dossier local ne contient pas encore d'application Flutter. Tout ce qui est décrit ici est une **cible documentée**, pas une fonctionnalité déjà réalisée.
